...
const Sf4 = { fontFamily: "'Fraunces', Georgia, serif" };
...
const Shell4 = ({ t, active, children }) =>
...
const Btn4 = ({ t, primary, children, icon }) =>
...
const Title4 = ({ t, title, sub, right, IconC }) =>
...
const Quiz4ActiveTF   = ({ t }) => <Quiz4Active t={t} qtype="tf"   />;
const Quiz4ActiveFill = ({ t }) => <Quiz4Active t={t} qtype="fill" />;
const Quiz4ActiveOpen = ({ t }) => <Quiz4Active t={t} qtype="open" />;
...
// ─────────────────────────────────────────────────────────────────────────────
const ViewShell4 = ({ t, title, activeTab, tabs, children }) => (
...
// ─────────────────────────────────────────────────────────────
const ProfileUsernameCooldown4 = ({ t }) => {
  return (
    <Shell4 t={t} active="dash">
      <div style={{ filter:"blur(2px)", opacity:0.22, pointerEvents:"none" }}>
        <div style={{ height:240, background:t.panel, border:`1px solid ${t.rule}` }} />
...
const NotificationsPomodoro4 = ({ t }) => {
...
const make4 = (k) => {
  ...
  return {
    Dash:           () => <Dash4           t={t} />,
    DashProc:       () => <Dash4Proc       t={t} />,
    DashResult:     () => <Dash4Result     t={t} />,
    Library:        () => <Lib4            t={t} />,
    Rooms:          () => <Rooms4          t={t} />,
    RoomsCreate:    () => <Rooms4Create    t={t} />,
    RoomsFriends:   () => <Rooms4Friends   t={t} />,
    RoomsGroups:    () => <Rooms4Groups    t={t} />,
    Academics:      () => <Aca4            t={t} />,
    Quiz:           () => <Quiz4           t={t} />,
    QuizMyQuizzes:  () => <Quiz4MyQuizzes  t={t} />,
    QuizExplore:    () => <Quiz4Explore    t={t} />,
    QuizHistory:    () => <Quiz4History    t={t} />,
    QuizGlobal:     () => <Quiz4Global     t={t} />,
    QuizPreview:    () => <Quiz4Preview    t={t} />,
    QuizActive:     () => <Quiz4Active     t={t} />,
    QuizActiveTF:   () => <Quiz4ActiveTF   t={t} />,
    QuizActiveFill: () => <Quiz4ActiveFill t={t} />,
    QuizActiveOpen: () => <Quiz4ActiveOpen t={t} />,
    QuizResult:     () => <Quiz4Result     t={t} />,
    Feedback:       () => <Fb4             t={t} />,
    Play:              () => <Play4              t={t} />,
    PlayLobby:         () => <Play4Lobby         t={t} />,
    PlayHost:          () => <Play4Host          t={t} />,
    PlayHostManual:    () => <Play4HostManual    t={t} />,
    PlayHostWait:      () => <Play4HostWait      t={t} />,
    PlayJoin:          () => <Play4Join          t={t} />,
    PlayFindMatch:     () => <Play4FindMatch     t={t} />,
    PlayBattle:        () => <Play4Battle        t={t} />,
    PlayBattleLeader:  () => <Play4BattleLeader  t={t} />,
    PlayResult:        () => <Play4Result        t={t} />,
    PlayLobbyMulti:    () => <Play4LobbyMulti    t={t} />,
    PlayBattleMulti:   () => <Play4BattleMulti   t={t} />,
    AcademicsTutor:    () => <Aca4Tutor           t={t} />,
    AcademicsExams:    () => <Aca4Exams           t={t} />,
    AcademicsSRS:      () => <Aca4SRS             t={t} />,
    AcademicsAnalytics:() => <Aca4Analytics       t={t} />,
    ContentView:       () => <Content4View        t={t} />,
    ContentViewBook:   () => <Content4Book        t={t} />,
    ContentViewAudio:  () => <Content4Audio       t={t} />,
    History:           () => <Hist4              t={t} />,
    RoomsActive:       () => <Rooms4Active       t={t} />,
    Profile:           () => <Profile4           t={t} />,
    Goals:             () => <Goals4             t={t} />,
    Notifications:     () => <Notifications4     t={t} />,
    ProfileSub:        () => <ProfileSub4        t={t} />,
    ProfileSubCancel:  () => <ProfileSubCancel4  t={t} />,
    ProfileBilling:    () => <ProfileBilling4    t={t} />,
    ProfileEdit:       () => <ProfileEdit4       t={t} />,
    ProfileUsername:      () => <ProfileUsername4      t={t} />,
    ProfileUsernameTaken: () => <ProfileUsernameTaken4 t={t} />,
    ProfileUsernameCooldown: () => <ProfileUsernameCooldown4 t={t} />,
    ProfileSubCanceled:   () => <ProfileSubCanceled4   t={t} />,
    ProfileSubFailed:     () => <ProfileSubFailed4     t={t} />,
    ProfileBillingEmpty:  () => <ProfileBillingEmpty4  t={t} />,
    Auth:              () => <Auth4            t={t} />,
    OnboardingLang:    () => <OnboardingLang4  t={t} />,
    OnboardingTheme:   () => <OnboardingTheme4 t={t} />,
    Pricing:           () => <Pricing4         t={t} />,
    Checkout:          () => <Checkout4        t={t} />,
    PaymentSuccess:    () => <PaymentSuccess4   t={t} />,
    PaymentCancel:     () => <PaymentCancel4    t={t} />,
    AccountSuspended:  () => <AccountSuspended4 t={t} />,
    ShareView:         () => <ShareView4        t={t} />,
    Informational:     () => <Informational4    t={t} />,
    GroupChat:            () => <GroupChat4            t={t} />,
    ContentViewMindMap:   () => <ContentViewMindMap4   t={t} />,
    ContentViewFlashcard: () => <ContentViewFlashcard4 t={t} />,
    NotificationsPomodoro:() => <NotificationsPomodoro4 t={t} />,
    InsufficientCredits:  () => <InsufficientCredits4  t={t} />,
    Tutorial:             () => <Tutorial4             t={t} />,
    NotFound:             () => <NotFound4             t={t} />,
    Achievements:         () => <Achievements4         t={t} />,
    ChatAssistant:        () => <ChatAssistant4        t={t} />,
    FloatingMiniPlayer:   () => <FloatingMiniPlayer4   t={t} />,
    LowCreditBanner:      () => <LowCreditBanner4      t={t} />,
  };
};

const themeKeys = Object.keys(T);
themeKeys.forEach((k) => {
  const m = make4(k);
  Object.entries(m).forEach(([page, C]) => {window["S4_" + k + "_" + page] = C;});
});
window.S4_themes = T;