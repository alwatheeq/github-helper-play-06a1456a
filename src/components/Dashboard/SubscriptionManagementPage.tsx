    ...
    <div className={shell}>
      ...
      {showCancelModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className={`bg-card-light dark:bg-card-dark rounded-[var(--s4-radius-card)] shadow-[var(--s4-shadow-modal)] border border-divider dark:border-divider-on-dark max-w-md w-full p-6`}>
            <div className="flex items-center justify-between mb-4">
