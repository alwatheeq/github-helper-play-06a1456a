    ...
    return (
      ...
      >
        ...
        <button
          onClick={generate}
          disabled={loading}
          className="inline-flex items-center gap-2 bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700 disabled:opacity-60 transition-colors"
        >
          {loading ? (
            <>
