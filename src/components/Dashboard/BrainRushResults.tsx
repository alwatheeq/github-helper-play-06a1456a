...
export const BrainRushResults: React.FC<BrainRushResultsProps> = ({
  ...
  const loadParticipantStats = async () => {
    ...
    try {
      ...
      ErrorLogger.error(err, { component: 'BrainRushResults', action: 'loadStats', gameSessionId: gameSession.id });
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400">{gameSession.game_title}</p>
      </div>
        ...
        <div className="flex items-end justify-center space-x-4 mb-8">
          ...
          {participantStats[1] && (
            <div className="text-center pb-8">
              <div className="bg-gradient-to-br from-gray-300 to-gray-400 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-3 shadow-lg">
                <span className="text-3xl font-bold text-gray-900">2</span>
              </div>
              <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-4 min-w-[140px]">
          ...
          {winner && (
            <div className="text-center">
              ...
              <div className="bg-gradient-to-br from-yellow-300 to-yellow-500 rounded-full w-28 h-28 flex items-center justify-center mx-auto mb-3 shadow-2xl">
          ...
          {participantStats[2] && (
            <div className="text-center pb-16">
              <div className="bg-gradient-to-br from-orange-400 to-orange-500 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-3 shadow-lg">
      ...
      {/* Game Summary */}
      <div className={`${getThemeGradient('bg')} rounded-2xl p-6 mb-6`}>
        <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-4">Game Summary</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">Total Questions</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{gameSession.total_questions}</p>
          </div>
          <div className="text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">Players</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{participantStats.length}</p>
          </div>
          <div className="text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">Difficulty</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 capitalize">{gameSession.difficulty_level}</p>
          </div>
          <div className="text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">Top Score</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{winner?.participant.score.toLocaleString()}</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center">
        <button
          ...
          className={`px-8 py-4 ${getThemeGradient('ui')} text-white rounded-xl hover:opacity-90 transition font-semibold flex items-center space-x-2 shadow-lg`}
        >
