...
export const ExamScheduler: React.FC<ExamSchedulerProps> = ({ courseId }) => {
  ...
  return (
    <div className="space-y-5" dir={dir}>
      ...
      {/* Upcoming banner */}
      {upcoming && (
        <div className="flex items-center gap-3 px-[18px] py-3 rounded-[10px] bg-accent-gold-soft border border-accent-gold">
      ...
      {/* Inline add form */}
      {showForm && (
        <div className="bg-card-light dark:bg-card-dark border border-divider dark:border-divider-on-dark p-4 space-y-3">
          <input
            type="text"
            value={newName}
        ...
        <div className="space-y-3">
          {exams.map((exam) => {
            ...
            return (
              <div
                key={exam.id}
                className={`flex items-center gap-[14px] py-[14px] px-[18px] rounded-[10px] border transition-colors ${
                  countdown.isPast
              ...
              >
                {/* Date icon */}
                <div className={`shrink-0 w-10 h-10 rounded-[10px] flex flex-col items-center justify-center border ${
                  countdown.isPast
