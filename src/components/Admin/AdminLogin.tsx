      ...
      <div className="max-w-md w-full">
        <div className="bg-card-light dark:bg-card-dark border border-divider dark:border-divider-on-dark p-8">
          <div className="flex justify-center mb-8">
            <div className="bg-accent-gold-soft p-6 border border-divider dark:border-divider-on-dark">
              <Shield className="h-12 w-12 text-ink dark:text-ink-on-dark" />
            </div>
          </div>

          <h2 className="text-3xl font-bold text-center text-ink-on-dark mb-2">
            Admin Portal
          </h2>
          <p className="text-center text-muted-ink-on-dark mb-8">
            Sign in to access the administration panel
          </p>

          {error && (
            <div className="mb-8 p-6 bg-red-900/30 border border-red-800 dark:border-red-300 flex items-start space-x-3">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-muted-ink-on-dark mb-2">
                Email Address
              </label>
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-muted-ink-on-dark" />
                <input
                  id="email"
                  type="email"
                  value={email}
                  ...
                  required
                  className="w-full pl-10 pr-4 py-3 bg-card-light dark:bg-card-dark border border-divider dark:border-divider-on-dark rounded-[12px] text-ink dark:text-ink-on-dark placeholder:text-muted-ink-on-dark focus:outline-none focus-visible:ring-2 focus-visible:ring-focus transition"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-muted-ink-on-dark mb-2">
                Password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-muted-ink-on-dark" />
                <input
                  id="password"
                  type="password"
                  value={password}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-accent-gold text-ink-on-dark py-3 px-6 font-semibold hover:opacity-90 focus-visible:ring-2 focus-visible:ring-focus disabled:opacity-50 disabled:cursor-not-allowed transition"
            >
          ...
          <div className="mt-8 text-center">
            <button
              onClick={() => navigate('/')}
              className="text-sm text-accent-gold hover:opacity-80 transition"
            >
        ...
        <p className="text-center text-sm text-muted-ink-on-dark mt-8">
