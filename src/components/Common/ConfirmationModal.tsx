...
export const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-[var(--s4-radius-card)] shadow-[0_1px_3px_0_rgba(0,0,0,0.08),0_1px_2px_0_rgba(0,0,0,0.06)] dark:shadow-lg max-w-md w-full overflow-hidden animate-scaleIn border border-gray-100 dark:border-gray-700">
        <div className="p-6">
