...
export const AccountSuspended: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-red-100 dark:from-gray-900 dark:to-gray-950 p-4">
      <div className="max-w-md w-full bg-card-light dark:bg-card-dark rounded-[var(--s4-radius-card)] shadow-[0_1px_3px_0_rgba(0,0,0,0.08),0_1px_2px_0_rgba(0,0,0,0.06)] dark:shadow-[var(--s4-shadow-modal)] p-8 border border-red-200 dark:border-red-900">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-card-dark hover:bg-card-dark text-ink-on-dark rounded-[var(--s4-radius-card)] transition"
          >
